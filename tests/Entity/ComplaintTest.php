...
final class ComplaintTest extends AbstractEntityTestCase
{
    ...
    {
        return [
            'wxComplaintId' => ['wxComplaintId', 'test_complaint_123'],
            'complaintTime' => ['complaintTime', '2023-01-01 12:00:00'],
            'payerPhone' => ['payerPhone', '13800138000'],
            'payOrderNo' => ['payOrderNo', 'ORDER12345'],
            'wxPayOrderNo' => ['wxPayOrderNo', 'WXORDER12345'],
            'amount' => ['amount', 100.50],
            'userComplaintTimes' => ['userComplaintTimes', 2],
            'applyRefundAmount' => ['applyRefundAmount', 50.25],
            'rawData' => ['rawData', '{"test": "data"}'],
            'complaintDetail' => ['complaintDetail', 'Test complaint detail'],
            'problemDescription' => ['problemDescription', 'Test problem description'],
            'complaintFullRefunded' => ['complaintFullRefunded', true],
        ];
    }
